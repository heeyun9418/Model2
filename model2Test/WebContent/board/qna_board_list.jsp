...
<body>
	<section id="listForm">
		<h2>
			글 목록<a href="boardWriteForm.do">게시판 글 쓰기</a>
		</h2>
		<table>
			<%
		...
		%>
			...
			<tr>
				...
				<td>
					...
					<% } %> ▶ 
					<% }else { %> ▶ <% } %>
						<a href="boardDetail.do?board_num=<%=articleList.get(i).getBoard_num() %>
						&page=<%=nowPage%>"><%= articleList.get(i).getBoard_subject() %></a>
				</td>
