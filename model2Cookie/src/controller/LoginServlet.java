...
public class LoginServlet extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		if (cookieArray != null) {
			...
			loginMember = loginService.getLoginMember(id, passwd);

		}
		if (loginMember != null) {
			RequestDispatcher ds = request.getRequestDispatcher("loginSuccess.jsp");
			request.setAttribute("loginMember", loginMember);
			ds.forward(request, response);
		} else {
			RequestDispatcher ds = request.getRequestDispatcher("loginForm.html");
			ds.forward(request, response);
		}
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		if (loginMember != null) {
			...
			RequestDispatcher ds = request.getRequestDispatcher("loginFail.jsp");
			ds.forward(request, response);
		}
	}
